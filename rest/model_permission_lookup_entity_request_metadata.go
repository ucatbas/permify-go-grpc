...
// checks if the PermissionLookupEntityRequestMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PermissionLookupEntityRequestMetadata{}

// PermissionLookupEntityRequestMetadata PermissionLookupEntityRequestMetadata metadata for the PermissionLookupEntityRequest.
...
func NewPermissionLookupEntityRequestMetadata() *PermissionLookupEntityRequestMetadata {
	this := PermissionLookupEntityRequestMetadata{}
	return &this
}
...
func (o PermissionLookupEntityRequestMetadata) MarshalJSON() ([]byte, error) {
...
func (o PermissionLookupEntityRequestMetadata) ToMap() (map[string]interface{}, error) {
...
type NullablePermissionLookupEntityRequestMetadata struct {
	value *PermissionLookupEntityRequestMetadata
	isSet bool
}

func (v NullablePermissionLookupEntityRequestMetadata) Get() *PermissionLookupEntityRequestMetadata {
	return v.value
}

func (v *NullablePermissionLookupEntityRequestMetadata) Set(val *PermissionLookupEntityRequestMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullablePermissionLookupEntityRequestMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullablePermissionLookupEntityRequestMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePermissionLookupEntityRequestMetadata(val *PermissionLookupEntityRequestMetadata) *NullablePermissionLookupEntityRequestMetadata {
	return &NullablePermissionLookupEntityRequestMetadata{value: val, isSet: true}
}

func (v NullablePermissionLookupEntityRequestMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePermissionLookupEntityRequestMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
