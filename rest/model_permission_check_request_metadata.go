...
// checks if the PermissionCheckRequestMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PermissionCheckRequestMetadata{}

// PermissionCheckRequestMetadata PermissionCheckRequestMetadata metadata for the PermissionCheckRequest.
...
func NewPermissionCheckRequestMetadata() *PermissionCheckRequestMetadata {
	this := PermissionCheckRequestMetadata{}
	return &this
}
...
func (o PermissionCheckRequestMetadata) MarshalJSON() ([]byte, error) {
...
func (o PermissionCheckRequestMetadata) ToMap() (map[string]interface{}, error) {
...
type NullablePermissionCheckRequestMetadata struct {
	value *PermissionCheckRequestMetadata
	isSet bool
}

func (v NullablePermissionCheckRequestMetadata) Get() *PermissionCheckRequestMetadata {
	return v.value
}

func (v *NullablePermissionCheckRequestMetadata) Set(val *PermissionCheckRequestMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullablePermissionCheckRequestMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullablePermissionCheckRequestMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePermissionCheckRequestMetadata(val *PermissionCheckRequestMetadata) *NullablePermissionCheckRequestMetadata {
	return &NullablePermissionCheckRequestMetadata{value: val, isSet: true}
}

func (v NullablePermissionCheckRequestMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePermissionCheckRequestMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
